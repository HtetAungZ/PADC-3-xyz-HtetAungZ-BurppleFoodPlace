...
public class OkHttpPromotionsDataAgent implements PromotionsDataAgent {


    private static OkHttpPromotionsDataAgent sObjInstance;


    private OkHttpPromotionsDataAgent() {

    }

    public static OkHttpPromotionsDataAgent getsObjInstance() {

        if (sObjInstance == null) {
            sObjInstance = new OkHttpPromotionsDataAgent();
        }
